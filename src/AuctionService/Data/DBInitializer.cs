...
{
    // This method is a static method for initializing the database.
    // It is called during application startup to set up the database.
    public static void InitDb(WebApplication app)
    {
        // Creating a scope to retrieve services.
        using var scope = app.Services.CreateScope();

        // Calling the SeedData method to populate the database with initial data.
        SeedData(scope.ServiceProvider.GetService<AuctionDbContext>());
    }

    // This private static method seeds the database with initial data.
    private static void SeedData(AuctionDbContext context)
    {
        // Applying any pending migrations to the database.
        context.Database.Migrate();

        // Checking if there are already auctions in the database to avoid re-seeding.
        ...
        // Creating a list of auctions with pre-defined data for seeding.
        var auctions = new List<Auction>()
        {
            // Adding various auction entries here.
            // Each entry specifies details like auction ID, status, reserve price, seller, end date, and item details.
            
            // Example: Ford GT Auction
            new Auction
            {
        ...
        // Adding the list of auctions to the context for saving.
